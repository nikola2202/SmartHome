...
namespace SmartHome.Migrations
{
    ...
    [Migration("20210315131208_numberParameterAdded")]
    partial class numberParameterAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartHome.Models.NumberParameter", b =>
                {
                    ...
                    b.Property<long?>("NumberParameterId1")
                        .HasColumnType("bigint");

                    b.HasKey("NumberParameterId");

                    b.HasIndex("NumberParameterId1");
            ...
            modelBuilder.Entity("SmartHome.Models.NumberParameter", b =>
                {
                    b.HasOne("SmartHome.Models.NumberParameter", null)
                        .WithMany("NumberParameters")
                        .HasForeignKey("NumberParameterId1");
                });
